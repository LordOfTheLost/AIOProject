[size=3][color=crimson][b]AIO Project[/b][/color][/size] [offtop][url="https://sourceforge.net/projects/aioproject/"]SF[/url] || [url="https://drive.google.com/drive/u/1/folders/1y4ckTGH29DlK7MjZ7EwH9m1CdYV42oHK"]GD[/url] || ([url="https://4pda.ru/forum/index.php?showuser=6892995/"]TG в профиле (беты и обсуждение)[/url])[/offtop]
...
[b][color=teal]Разработчик:[/color][/b] [url="https://4pda.ru/forum/index.php?showuser=6892995/"]Lord Of The Lost[/url].
...
• Скачать: [url="https://sourceforge.net/projects/aioproject/files/25.04.2021/AIOPFMD-25.04.21-%2836%29.zip/download"]AIOPFMD 25.04.21 (36)[/url] [offtop][sub]SF[/sub][/offtop] || [url="https://drive.google.com/file/d/1am3vhavTDX3-haFlkcKlyMMHQ3CKPsux/view?usp=sharing"]AIOPFMD 25.04.21 (36)[/url] [offtop][sub]GD[/sub][/offtop] [url="https://github.com/LordOfTheLost/AIOProject/blob/main/AIOPFMD%20Changelog.sh"]Changelog[/url] [spoiler="Принцип/Порядок работы AIOPFMD"]• Пункт (DEBUGMODE & M Only & TWRP Only) - Если находит что у вас установлен Magisk, предлагает выбор: Установить ВСЁ что устанавливается, как модуль Magisk(M) или переделанным скриптом из под моего патча установка в систему напрямую (у кого нет рут прав/боязнь их);
...
• Пункт (All) (10-11) (\) - Установка высоты жестовой "таблетки" в значениях:
	...
	- Значение 9;
	- Значение 10;
• Пункт (All) [url="https://github.com/null4n/navbar-overlay">GITHUB</a> - Hide Or Show Nav Bar:
	- Build.prop вариант:
		- Показать;
		- Скрыть;
...
• Пункт (All) - Установка Media Ui:
	...
	- OnePlus;
	- Pixel;
	- Samsung;[/spoiler][spoiler="Apps: GFU/GSF/SL/IA"]
...
• Пункт (All) (10-11) (\) - Установка Systemless Launcher (Alt Variant Quick Switch):
	...
	- Установка OPLauncher [url="https://github.com/MrSluffy/LauncherMods">GITHUB</a>;
	- Установка OneUIHome;
	- Установка PixelLauncherX [url="https://github.com/MrSluffy?tab=repositories">GITHUB</a>;
	- Установка ShadyLauncher;
	- Установка AsusLauncher [url="https://github.com/MrSluffy?tab=repositories">GITHUB</a>;
...
• Пункт (All) - Начать установку из под /sdcard/Applications если в этой папки есть приложения;
	...
	- Без подтверждением;[/spoiler][spoiler=Audio: VFX(P)/DSP/DTS/AML/AN]
• Пункт (All) [url="https://github.com/Magisk-Modules-Repo/ViPER4AndroidFX-Legacy">GITHUB</a> [url="https://github.com/Magisk-Modules-Repo/ViPER4Android-FX">GITHUB</a> [url="https://forum.xda-developers.com/apps/magisk/module-viper4android-fx-2-5-0-5-t3577058"]XDA[/url] - Установка ViperFX:
...
• Пункт (Only M) (5.1.1+) [url="https://github.com/Magisk-Modules-Repo/ainur_jamesdsp">GITHUB</a> [url="https://github.com/therealahrion/JamesDSPManager">GITHUB</a> [url="https://github.com/james34602/JamesDSPManager">GITHUB</a> [url="https://github.com/james34602/JamesDSPManager">GITHUB</a> - Установка James DSP Manager:
	- Новый менеджер;
	- Старый менеджер:
		- Драйвера Full Feature;
		- Драйвера Bit Perfect;
• Пункт (Only M) (9-11) [url="https://forum.xda-developers.com/t/port-pie-dts-x-ultra-dts-headphone-x-27-03-update.3896233/"]XDA[/url] - Установка DTS HPX:
	- Новый менеджер;
	- Старый менеджер;
• Пункт (Only M) [url="https://github.com/Magisk-Modules-Repo/aml">GITHUB</a> [url="https://github.com/Zackptg5/Audio-Modification-Library">GITHUB</a> - Установка Audio Modification Library;
• Пункт (Only M) [url="https://github.com/Magisk-Modules-Repo/ainur_narsil">GITHUB</a> [url="https://forum.xda-developers.com/android/software/soundmod-ainur-audio-t3450516?__cf_chl_jschl_tk__=7d29d957158150c94eaa400d55500acd4fdcdf7b-1600982384-0-AfLI9NbkLXp9kh05wbmzJNHd97-th79IsBfC533jA9X3Af98u1bPRxYWtrj263UGihzscD4YjLD0DVzBXilUDe_8taFFdGPMpGWLUHjoArN-KC2BjhBxVJtjVuaYP-YaaVPLY1bvCPb5oKo7JhQ2acr0ytal99ZFrZ5cyNsFTUKdiemERMTsGhsdmF-jXyelg3_kyduRSa8Ik2_gt6-rhlPd1dvY5qUgkIXT6Hp6aOpwVUa73Y5lxCm-tqcenFWyvV4usMTrNUfwr_mRea1oZbDUgOErLnMofOCKlUVD8VaNZz-ljxNVeyeuTazN98tHqqjK034W81anVfl-j_IzMDSJrn5rknKlcxkmWXW0KpVN7XAbW9PtO8ey_8Ct5WG8ytokh02XBJsfTg9h8FB_7zk"]XDA[/url] [url="https://4pda.ru/forum/index.php?s=&showtopic=744922&view=findpost&p=49541743"]4PDA[/url] - Установка Ainur Narsil;
...
[/spoiler][spoiler="Other Fixes: FBFM/FBFM/UAA"]
...
• Пункт (Only TWRP) - Разморозка всех замороженных приложений (если вы заморозили что-то через TB/тп. после чего bootloop/отвал);[/spoiler][spoiler=Removal: RSL/RSO/RSTA/RWFSB]
...
• Пункт (All) (\) - Режим удаления/replace (список будет пополнятся). Удаляйте что знаете, я разжёвывать не буду - [url="https://4pda.ru/forum/index.php?s=&showtopic=236256&view=findpost&p=7424759"]Узнать о почти всех приложения в этих списках можно в этой теме по поиску[/url]. Выбор в самом ММ появляется без своей категории:
	...
	- Отправлять их в replace (в bootmode по умолчанию он) (в TWRP и если есть Magisk будет этот выбор);
		...
		- Удаление найденных Apk без подтверждения каждого найденного (не касается того что в патче, там всегда с выбором);
			...
			- Если не находит /sdcard/rmlist.sh: пойдёт поиск приложений, и если был выбран выбор на подтверждение каждого удаления будет дан выбор: удалить его или искать следующие
				...
				- Удаление лаунчеров; [spoiler="Списки приложений которые удаляются"]
[spoiler="Удаление приложений которые не влияют на работу прошивки"]Удаляется если не Miui, но в режиме с выбором если Miui - появляется:
Calculator
Calendar
Contacts
DeskClock
...
messaging
stats
talkback[/spoiler][spoiler="Удаление приложений которые могут повлиять на работу прошивки"]AmbientSensePrebuilt
...
WebView
WebViewGoogle
WebViewStub[/spoiler][spoiler="Удаление лаунчеров"]AsusLauncher
AsusLauncherDev
EasyLauncher2_Zero
EnigmaLauncher
Launcher3QuickStep
...
TWLauncherESS
Trebuchet
TrebuchetQuickStep[/spoiler][/spoiler]• Пункт (Only TWRP) - Удаление обоев (Fix Softloop (кто сталкивался, тот знает зачем он)) - появляется только если у вас стоят обои картинкой;
• Пункт (Only TWRP) - Удаление runtime-permissions.xml в /data/misc_de/0/apexdata/com.android.permission - не обращайте на него внимание, это для моих постоянных softlooпов (делал для себя и тех, у кого будет то, о чем знают лишь те, кто знает зачем это надо);[/spoiler][spoiler="AdBlock/Hosts"]
• Пункт (All) (\) - Установка одного из пяти Hosts файлов:
	- Пустой Hosts (Отключение блокировки);
	- Hosts из AdAway (12000+ строк) [url="https://github.com/AdAway/adaway.github.io">GITHUB</a>;
	- Hosts из LP от chelpa (67000+ строк) [url="https://4pda.ru/forum/index.php?s=&showtopic=298302&view=findpost&p=10727871"]4PDA[/url];
	- От gloeyisk (90000+ строк) [url="https://github.com/gloeyisk/SystemlessHosts">GITHUB</a>;
	- Альтернативный (в нем строки из MiRoom и других) (190000+ строк);[/spoiler][spoiler="Net: GPS/TTL/DNS/WB"]
• Пункт (All) (Only MSM/SDM) [url="https://github.com/Magisk-Modules-Repo/optmizedgpsconf">GITHUB</a> - Установка Global Optimized GPS (добавляет оптимизированные строки в gps.conf (поддержку CN оставил));
• Пункт (Only M) [url="https://github.com/cyborg-one/nfqttl">GITHUB</a> [url="https://4pda.ru/forum/index.php?s=&showtopic=915158&view=findpost&p=101870586"]4PDA[/url] - Установка TTL Fix;
• Пункт (All) - Установка Network Tweak - альтернативный DNS-сервер от Google или CloudFlare:
	- Google и CloudFlare DNS;
	- По отдельности:
		- Google DNS;
		- CloudFlare DNS;
• Пункт (All) [url="https://github.com/Magisk-Modules-Repo/wifi-bonding">GITHUB</a> - Установка Wifi Bonding для увеличения пропускной способности Wifi;[/spoiler][spoiler="Utilities: BB/ZSigner/SELC/ASTE/CC"]
• Пункт (All) [url="https://github.com/feravolt/Brutal_busybox">GITHUB</a> [url="https://4pda.ru/forum/index.php?s=&showtopic=915158&view=findpost&p=95475185"]4PDA[/url] - Установка Busybox с активацией симлинков (для bin или xbin);
• Пункт (All) [url="https://github.com/Magisk-Modules-Repo/zipsigner">GITHUB</a> [url="https://forum.xda-developers.com/showthread.php?t=2239421&__cf_chl_jschl_tk__=4984b5a76074a8f92f17c55fee2071aa1574e768-1594480192-0-ATXVAJgNEEJLDRbUbS3P4jRknd7-87y5tw9mUcw2j7kUIuWKvH37sHd2Oyii9vwlK2Q9DPkZkpv-x5cOt_BLvYCk_tL_4nAeUjS0UMBrPyLD8Kc7hA0joixn6aAvHGrSnlYn4KjFKCmnrf6zX1uAo53Kbs-REH3waSfoI1Zdsj8sEIXmA5bsgRPuqirEXvB2T9TXYtt61Y4smtb2beJ3NxoXAjdZTM9G3VB89h8FhEmzdGycuafim2fS9tLKWCHlZoaiKtlGe2cEy7wU8j-RVJen3l91-_jFZdClbNRogoIy2U92RkejzrXO81FV-pANEp-8-Qe6YkXevo564gBm_ChO0TxyJEbMI9YoZLRlM5Av"]XDA[/url] - Установка ZipSigner и aapt;
...
• Пункт (Only М) [url="https://github.com/Magisk-Modules-Repo/terminal_systemizer">GITHUB</a> [url="https://forum.xda-developers.com/apps/magisk/module-terminal-app-systemizer-ui-t3585851"]XDA[/url] - Установка App Systemizer (Terminal Emulator);
...
• Пункт (Only М In BootMode) [url="https://github.com/Magisk-Modules-Repo/Detach">GITHUB</a> [url="https://forum.xda-developers.com/t/module-detach3-detach-market-links.3447494/"]XDA[/url] - Установка Detach - установка из под своего архива;
• Пункт (All) [url="https://github.com/stylemessiah/SQLite3-Universal-Binaries">GITHUB</a> - Установка ISQLite3 - необходим для некоторых модулей;
• Пункт (Only М) [url="https://github.com/Rikj000/mm">GITHUB</a> [url="https://forum.xda-developers.com/t/2019-4-4-magisk-manager-for-recovery-mode-mm.3693165/"]XDA[/url] - Установка Magisk Manager For Recovery Mode - для более удобного управления модулями;[/spoiler][spoiler="Other: GPay/DFO/STZD/DDVFE/FA"]
• Пункт (All) [url="https://github.com/stylemessiah/GPay-SQLite-Fix">GITHUB</a> [url="https://forum.xda-developers.com/showpost.php?p=79643248&postcount=176"]XDA[/url] - Установка GPay SQLite Fix (появляется если патч находи NFC модуль и установлено приложение Gpay);
...
• Пункт (All) [url="https://github.com/Magisk-Modules-Repo/Systemless_TZData">GITHUB</a> - Установка Systemless TZData - для обновления на не обновляемых tzdata в древних прошивках;
• Пункт (Only TWRP) [url="https://github.com/Zackptg5/Disable_Dm-Verity_ForceEncrypt">GITHUB</a> [url="https://forum.xda-developers.com/android/software/universal-dm-verity-forceencrypt-t3817389/post77091359"]XDA[/url] - Установка Disable Dm Verity Force Encrypt из под своего бинирника;
• Пункт (All) (\) - Установка Fingerprint Actions Mod для многих прошивок с выборами (выбор появляется только если в телефоне есть сканер отпечатка пальца):
	...
	- Запуск Gmail/Mail;[/spoiler][spoiler="Safety Net & MHPC"]
• Пункт (Only М) (\) [url="https://4pda.ru/forum/index.php?s=&showtopic=774072&view=findpost&p=83848558"]4PDA[/url] - Установка трёх актуальных (пока ещё актуальных) и универсальных SafetyNet патча;
	- 1-й SafetyNet патч;
	- 2-й SafetyNet патч [url="https://forum.xda-developers.com/t/module-safetypatcher.3809879/"]XDA[/url];
	- 3-й SafetyNet патч (7-11) [url="https://github.com/kdrag0n/safetynet-fix">GITHUB</a> [url="https://forum.xda-developers.com/t/magisk-module-universal-safetynet-fix-1-1-0.4217823/#post-84286769"]XDA[/url];
...
• Пункт (Only М) [url="https://github.com/Magisk-Modules-Repo/MagiskHidePropsConf">GITHUB</a> [url="https://forum.xda-developers.com/apps/magisk/module-magiskhide-props-config-t3789228?__cf_chl_jschl_tk__=a3131f7d48bc8aca910b13d152bfc50a282715ba-1593970618-0-ASbD84SVNaBpNlWp_-NU5N29InliDM9nuc7Xrm7kSHhzfEfTwdGfepfXiIIte7ykaweSPeRYWiUwx8VHfIudeqeNZEAfF1FcbQhGJgPKGlGlPGx7yojA6faOz75SePYLHb8I8UUMm3-3f8vXM9AM0nYhOx86imTcdZeKdJDVQ2akBmof7CrgYFlH32ffoDCnF7npcPqdSkacBjjUuRLEjjEgyfZZ-dUuKL1GdIH8Gf_-mIVxl3rxKFqmlcekGNGYx5PD2_wtfq6fUmIgdtY-bx9MySuKFGzu9gYjayR1J8FtKngzrhjoiTuM3jO0EaxV2m1UQhr2o2aLQ8BUXGZt0l8jHbrQSHqsbucM5OB8LjZNE7qiUAzAlT2R0xSJteD4ZKHRf35a403YF6YMrMaN6pw"]XDA[/url] - Установка Magisk Hide Props Config - из под своего бинирника (об этом способе я в чейнджлоге упоминал);[/spoiler][spoiler="Riru & EdXposed"]• Пункт (Only М) (8.1, 9.0, 10.0, 11.0) [url="https://github.com/RikkaApps/Riru">GITHUB</a> - Установка Riru Core - Установка не из под своего архива;
• Пункт (Only М) (8.1, 9.0, 10.0, 11.0) [url="https://github.com/ElderDrivers/EdXposed">GITHUB</a> [url="https://github.com/ElderDrivers/EdXposedManager">GITHUB</a> - Установка EdXposed - Установка не из под своего архива:
	- Если установка через MM, будет дан выбор на установку менеджера:
		- Установка в /data/app;
		- Установка в /system/priv-app;[/spoiler][spoiler="Tweaks: FGS/BP/LED/UGMSD/SBU/USGP/VS"]• Пункт (Only М And/Or BootMode) - Принудительная синхронизация Google (Если пишет Waiting to buck up или другие проблемы с синхронизацией);
...
• Пункт (Only М) (6-11) [url="https://github.com/gloeyisk/UniversalGMSDoze">GITHUB</a> [url="https://forum.xda-developers.com/apps/magisk/module-universal-gms-doze-t3853710"]XDA[/url] - Установка Universal GMS Doze;
...
• Пункт (All) (\) - Установка патча на изменение шагов громкости - по отдельности или нет, на: медиа/музыку, системную громкость, голосовой вызов, громкость будильника:
	...
	- Редактировать каждое значение отдельно;
		...
		- Значение 30;
		- Значение 35;
		- Значение 40;[/spoiler][/spoiler][/spoiler][spoiler=[b][color=Teal]All In One Cam Patch For More Devices (AIOCPFMD) (EOL)[/color][/b]]• Этот патч объединяет в себе следующие камеры: GCam от BSG, San1ty, Parrot043, Tigr, ANX и 48MPFixQ. Так же есть выбор удаления Сток камер и GСam (Go).
...
• Скачать: [url="https://sourceforge.net/projects/aioproject/files/28.03.2021/AIOCPFMD-28.03.21-%2832%29.zip/download"]AIOCPFMD 28.03.21 (32)[/url] [offtop][sub]SF[/sub][/offtop] || [url="https://drive.google.com/file/d/1CEDmbE3T5OA8Tr6JzWpRkVEEL5HNYSpD/view?usp=sharing"]AIOCPFMD 28.03.21 (32)[/url] [offtop][sub]GD[/sub][/offtop] [url="https://github.com/LordOfTheLost/AIOProject/blob/main/AIOCPFMD%20Changelog.sh"]Changelog[/url] [/spoiler][spoiler="Принцип/Порядок работы AIOCPFMD"]• Пункт (First Launch) - Если находит нужные файлы, предлагает использовать отклик/вибрацию при нажатии на клавиши громкости;
...
• Пункт (Only M) (<11) [url="https://camera.aeonax.com/#downloads"]Official Site[/url] - Устанавливает ANX Камеру:
	Android 11:
	- ANXCamera 185R;
	До Android 11:
	- Версии 190;
	...
	- Версии 185;
• Пункт (Only M) (<11) - Устанавливает ANX Addons 48Fix;[/spoiler][/spoiler][spoiler=[b][color=Teal]All In One Install And Remove Patch For More Divices (AIOIARPFMD) (EOL)[/color][/b]]Этот патч был создан полтора года назад как эксперимент, который некоторым понравился а один человек его и вовсе переделал под себя.
...
• Скачать: [url="https://sourceforge.net/projects/aioproject/files/28.03.2021/AIOIARPFMD-28.03.21-%2823%29.zip/download"]AIOIARPFMD 28.03.21 (23)[/url] [offtop][sub]SF[/sub][/offtop] || [url="https://drive.google.com/file/d/1KQli7Z_YKsNcaffwFbRqXy3P5IRr1Lt5/view?usp=sharing"]AIOIARPFMD 28.03.21 (23)[/url] [offtop][sub]GD[/sub][/offtop] [url="https://github.com/LordOfTheLost/AIOProject/blob/main/AIOIARPFMD%20Changelog.sh"]Changelog[/url] [spoiler="Принцип/Порядок работы AIOIARPFMD"]• Пункт (DEBUGMODE & M Only & TWRP Only) - Если находит что у вас установлен Magisk, предлагает выбор: Установить ВСЁ что устанавливается, как модуль Magisk(M) или переделанным скриптом из под моего патча установка в систему напрямую (у кого нет рут прав/боязнь их);
...
• Пункт (All) - Начать установку из под /sdcard/Applications если в этой папки есть приложения;
	- С подтверждением для каждого;
	- Без подтверждением;[/spoiler][/spoiler][spoiler=[b][color=Teal]Общие Известные проблемы[/color][/b]]
...
• Могут иметься другие баги о которых я не знаю (так же я могу сломать что-то старое что работало, добавив что-то новое (это норма)).[/spoiler][spoiler=[b][color=Teal]Полезная информация/Доп. Информация[/color][/b]][spoiler="Что на чем и где было протестировано"]
...
• На девайсах протестировано мною лично: [url="https://4pda.ru/devdb/xiaomi_mi8"]Mi8[/url], [url="https://4pda.ru/devdb/xiaomi_redmi_note_5_pro"]RN5[/url], [url="https://4pda.ru/devdb/redmi_note_7"]RN7[/url], [url="https://4pda.ru/devdb/jiayu_s3"]Jiayu S3[/url], [url="https://4pda.ru/devdb/samsung_gt_i9500_galaxy_s_4"]Samsung Galaxy S4[/url], [url="https://4pda.ru/devdb/sony_xperia_z5_dual"]Sony Xperia Z5 Dual[/url], [url="https://4pda.ru/devdb/samsung_galaxy_j3_2016_sm_j320f"]Samsung Galaxy J3 SM-J320H[/url].[/spoiler][spoiler="Почему, как и зачем"]
...
• Что в планах? Много всего, и на это нужно время и желание которого нету. Но это в любом случае когда-то случиться.[/spoiler][spoiler="Особые надписи и переменный в этих патчах и файле PATCHMODE"]
...
• (//) - Если не выбирать этот пункт, будет выход/завершение работы патча.[/spoiler][spoiler="Связь (до связи) и отзывы/пожелания"]
• Патчи буду добавляться/улучшаться по мере их нахождения/тестирования/времени и желания.
• Если есть проблемы/пожелания в [url="https://4pda.ru/forum/index.php?act=qms&code=no"]QMS[/url] (желательно с логами если были ошибки или что-то не сработало как надо).
• Этот пост объединение трех постов из тем [url="https://4pda.ru/forum/index.php?s=&showtopic=917843&view=findpost&p=83605714"]Mi8[/url], [url="https://4pda.ru/forum/index.php?s=&showtopic=894598&view=findpost&p=86009065"]RN5[/url] и [url="https://4pda.ru/forum/index.php?s=&showtopic=959481&view=findpost&p=89516033"]K20Pro[/url][/spoiler][/spoiler][right][img]https://s.4pda.to/forum/style_images/f/281-4545451.png[/img][/right]
