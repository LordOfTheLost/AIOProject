...
* Пункт (All) (10-11) (U+002F) - Установка разных видов/размеров жестовой "таблетки":
	...
	- Не прозрачная зона таблетки;
		...
		- Ширина таблетки (300);
			...
			- Размер таблетки (3);
			- Размер таблетки (4);
* Пункт (All) (10-11) (U+002F) - Установка разного цвета жестовой "таблетки":
	...
	- Выбрать разный цвет для Light и Dark который определяется самим приложением;
		...
		- Orange (ffff8055);
		- Violet (ffa86bd5);
* Пункт (All) (10-11) (U+002F) - Установка высоты жестовой "таблетки" в значениях:
	- Значение 1;
	- Значение 2;
	- Значение 3;
	- Значение 4;
...
* Пункт (All) <a href="https://github.com/null4n/navbar-overlay">GITHUB</a> - Hide Or Show Nav Bar:
	...
	- Вариант с Файлом оверлея:
		- Показать;
		- Скрыть;
* Пункт (All) (10-11) (U+002F) - Установка патча на увеличение отступов при использовании клавиатуры:
	- Значение 0 (Сток);
	- Значение 5;
	- Значение 10;
	- Значение 15;
	...
	- Значение 35;
	- Значение 40;
* Пункт (All) (10-11) (U+002F) - Установка патча на увеличение скругления нижних клавиш для GBoard (работает только на темах с контурами):
	- Значение 0 (Сток);
	- Значение 5;
	- Значение 10;
	- Значение 15;
...
* Пункт (All) (9-11) (U+002F) - Cutout Increase Number Notification Icons для многих прошивок с выборами: 
...
* Пункт (All) (10-11) (U+002F) - Установка патча на разную степень скругления системы, лаунчеров и приложений:
	- Значение 0;
	- Значение 5;
	- Значение 10;
	- Значение 15;
...
* Пункт (Only M) (8.1-11) (U+002F) - Установка патча SUI Content Padding - работает как CPadjustor для увеличения/уменьшения отступов от краев статусбара если доступно прошивкой;
	- Значение 0;
	- Значение 5;
	- Значение 10;
	- Значение 15;
	...
	- Значение 35;
	- Значение 40;
* Пункт (Only M) (8.1-11) (U+002F) - Установка патча QS Content Padding - для увеличения/уменьшения отступов от краев в панели быстрых настроек если доступно прошивкой;
	- Значение 0;
	- Значение 5;
	- Значение 10;
	- Значение 15;
	...
	- Значение 35;
	- Значение 40;
* Пункт (Only M) (8.1-11) (U+002F) - Установка патча SUI Rounded Size (не путать с RoundedUI) для скругления по краям экрана если доступно прошивкой;
	- Значение 10;
	- Значение 20;
	- Значение 30;
	- Значение 40;
	...
	- Значение 90;
	- Значение 100;
* Пункт (All) (U+002F) - Установка Boot Animation:
	- Pixel:
		- Black;
		- White;
	- OnePlus;
...
* Пункт (All) (10-11) (U+002F) - Установка Systemless Launcher (Alt Variant Quick Switch):
...
* Пункт (All) (U+002F) - Установка одного из пяти Hosts файлов:
...
* Пункт (All) (U+002F) - Установка Fingerprint Actions Mod для многих прошивок с выборами (выбор появляется только если в телефоне есть сканер отпечатка пальца):
	- Кнопка Включения;
	- Включение экрана;
...
* Пункт (Only М) (U+002F) <a href="https://4pda.ru/forum/index.php?s=&showtopic=774072&view=findpost&p=83848558">4PDA</a> - Установка трёх актуальных (пока ещё актуальных) и универсальных SafetyNet патча;
	- 1-й SafetyNet патч;
...
* Пункт (Only М) (U+002F) - Установка Start LEDLight Animation - при загрузке телефона будет мелькать светодиод, хард-клавиатура, фонарик (в зависимости какие у вас - поддерживаются красный, зеленый, синий и белый. Есть хардклавиатура или нет. В том разделе файл фонарика или нет) (на Mi8 прикольно вариант Only LED выглядит - он и рекомендуется):
...
* Пункт (All) (U+002F) - Установка патча на изменение шагов громкости - по отдельности или нет, на: медиа/музыку, системную громкость, голосовой вызов, громкость будильника:
...
* Я тестировал их на своих телефонах но это не означает что мне можно доверять (вдруг я вам /system форматну), так что Всё, что вы делаете со своим девайсом/телефоном - вы делаете на свой страх и риск.
...
* (U+002F) - Означающий что в этом пункте есть возможность выхода из подпунктов к следующему выбору.
...
* Если есть проблемы/пожелания в <a href="https://4pda.ru/forum/index.php?act=qms&code=no">QMS</a> (желательно с логами если были ошибки или что-то не сработало как надо) или писать в <a href="@AIOProject_Chat">TG Chat</a>.
