...
* Cache Cleaner обновлён до v2.6 - пару мелких фиксов и улучшений;
			...
			- Регулировка для правой стороны:
				...
				- Значение 4dip;
					- Регулировка для батареи:
						...
						- Значение 3dip;
						- Значение 4dip;
* Пункт (ALL) (10-12.1) (\\) - (Status Bar Icon Size) регулирует размер иконок уведомлений в статусбаре/свернутом статусбаре:
	- Значение 12dip;
	- Значение 13dip;
	- Значение 14dip;
	- Значение 15dip;
...
* Пункт (ALL) (10-12.1) (\\) - (Status Bar Padding) для увеличения/уменьшения отступов от краев статусбара;
...
* Что означает патч прошивается из под своего архива или нет:
	...
	- Почему сток патчи говно - вы прошили прошивку и MAGISK начисто и НЕ СМОЖЕТЕ прошить какой-либо модуль пока не загрузитесь в систему либо как в случае с NL всё полностью сломано.
